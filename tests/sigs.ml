...
module T_opaque :
sig 
  type sum deriving (Dump, Eq, Show, Typeable, Pickle, Compare)
  type nullsum deriving (Enum, Bounded, Eq, Typeable, Pickle, Compare)
  type r1 deriving (Dump, Eq, Show, Typeable, Pickle, Functor, Compare)
  type r2 deriving (Eq, Show, Typeable, Pickle)
  type r3 deriving (Eq, Show, Typeable, Pickle)
  type r4 
  type label
  type funct
  type intseq deriving (Dump, Eq, Show, Typeable, Pickle, Functor, Compare)
  type 'a seq deriving (Dump, Eq, Show, Functor, Typeable, Pickle, Compare)
  type uses_seqs deriving (Dump, Eq, Show, Typeable, Pickle, Compare)
  type obj
  type poly0 deriving (Enum, Bounded, Show, Eq, Typeable, Pickle, Compare)
  type poly1 deriving (Dump, Eq, Show, Compare)
  type poly2 deriving (Dump, Eq, Show, Compare)
  type poly3 deriving (Dump, Eq, Show, Typeable, Pickle, Compare) 
  type poly3b deriving (Dump, Eq, Show, Typeable, Pickle, Compare) 
  type 'a poly7 
  and 'a poly8 deriving (Dump, Eq, Show, Functor, Typeable, Pickle, Compare)
  type poly10 deriving (Dump, Eq, Show, Functor, Typeable, Pickle, Compare)
  type mutrec_a 
  and mutrec_b 
  and mutrec_c 
  and mutrec_d deriving (Dump, Eq, Show, Typeable, Pickle, Compare)
  type ('a,'b) pmutrec_a 
  and ('a,'b) pmutrec_b 
  and ('a,'b) pmutrec_c 
  and ('a,'b) pmutrec_d deriving (Dump, Eq, Show, Functor, Typeable, Pickle, Compare)
  type 'a ff1 deriving (Show, Eq, Dump, Functor, Typeable, Pickle, Compare)
  type ('a,'b) ff2 deriving (Dump, Eq, Show, Functor, Typeable, Pickle, Compare)
  type tup0 deriving (Dump, Eq, Show, Typeable, Pickle, Compare)
  type tup2 deriving (Dump, Eq, Show, Typeable, Pickle, Compare)
  type tup3 deriving (Dump, Eq, Show, Typeable, Pickle, Compare)
  type tup4 deriving (Dump, Eq, Show, Typeable, Pickle, Bounded, Compare)
  type withref deriving (Eq, Show, Typeable, Pickle)
  module M : sig type t deriving (Show, Eq, Dump, Compare) end
  ...
  type t deriving (Eq, Enum, Bounded, Dump, Show, Typeable, Pickle, Functor, Compare)
end
  = Tests_defs
